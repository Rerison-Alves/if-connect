...
public class RecyclerViewUsuariosTodos extends RecyclerView.Adapter<RecyclerViewUsuariosTodos.ViewHolder> {
    Context context;
    ...
    public RecyclerViewUsuariosTodos(Context context, List<Usuario> usuariosConvidados, List<Usuario> usuariosTodos, DialogConvidaUsuario dialog) {
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") int position){
        ...
        holder.card.setOnClickListener(view -> {
            Usuario usuarioSelecionado = usuariosTodos.remove(position);
            usuariosConvidados.add(usuarioSelecionado);
